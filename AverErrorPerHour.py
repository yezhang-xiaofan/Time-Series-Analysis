#This file computes the average error over all offices in each bucket using time + week method
# and plots the figure (average error against bucket)
...
for office in OfficeId:
    ...
    if (ComKeyDic(CountTime,TestTime)==True):
        ...
        for key in CountTime:
            CountTime[key].append(CountTime[key][0]/CountTime[key][1])    #Total waiting time/total times
